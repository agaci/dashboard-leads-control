...
export const MATERIAIS_INICIAIS: Omit<CrmMaterial, '_id'>[] = [
  ...[
    ...
    'Produtos alimentares (nao pereciveis)',
    'Produtos alimentares (pereciveis / refrigerados)',
    'Vestuario / Calcado / Texteis',
    'Mobiliario / Decoracao',
    'Material de construcao',
    'Ferramentas / Equipamento industrial',
    'Obras de arte / Antiguidades (fragil)',
    'Vidro / Ceramica (fragil)',
  ...
  { valor: 'Mudanca de casa / escritorio',    label: 'Mudança de casa / escritório',    categoria: 'mudancas',      ordem: 1000, active: true },
