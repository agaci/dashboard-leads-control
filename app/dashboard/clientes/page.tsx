          ...
          {!loading && clients.map(c => (
            <div
              ...
              style={{
                ...
                background: selected?.id === c.id ? 'rgba(0,188,212,0.07)' : 'transparent',
              }}
            >
                ...
                {detail.leads.map(l => {
                  ...
                  return (
                    <div key={l.id} style={{
                      ...
                      {price != null && (
                        <span style={{ fontWeight: 700, fontSize: 14, color: '#22c55e', fontFamily: 'Space Grotesk, sans-serif' }}>
                          €{price.toFixed(2)}
                        </span>
                      )}
                      <span style={{
                        fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 4,
                        background: 'rgba(0,188,212,0.12)', color: '#00bcd4', flexShrink: 0,
                      }}>
                        {l.variante ?? 'Manual'}
                      </span>
                    </div>
