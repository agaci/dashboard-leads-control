...
const DEFAULTS = {
  ...
  messageTemplate:
    'Ola {nome}, aqui e a YourBox. Vi que comecou a pedir um orcamento ({rota}) mas nao chegou a concluir. Quer que tratemos disso por si? Responda aqui ou ligue 214 304 546 — e rapido.',
  startHour: 9,
  endHour: 20,
  weekendsOff: true,
};
